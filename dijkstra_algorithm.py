...
# קריאת התמונה פעם אחת
img = cv2.imread(file)
cv2.circle(img, (22, 315), 3, (255, 0, 0), -1)  # הוספת עיגול בנקודת התחלה
cv2.circle(img, (330, 326), 3, (0, 0, 255), -1)  # הוספת עיגול בנקודת סיום
img_copy = img.copy()  # שמירה של עותק של התמונה המקורית

print(img.shape)

# הכנת התמונה למבנה גרפי
img = img[:, :, 0] // 200
...
draw_path(img_copy, path)
plt.figure(figsize=(7, 7))
plt.imshow(img_copy)  # הצגת התמונה עם המסלול על המסך
plt.show()
